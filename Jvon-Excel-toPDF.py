...
template_path = 'C:\Users\Jzzz\Desktop\jvon convert\LSD.docx'
...
for i in range(1,max_row):
    ...
    Name = all.Name[i-1]
    doc.SaveAs("C:\Users\Jzzz\Desktop\jvon convert\LotusSmileDental/"+Name+".doc")
